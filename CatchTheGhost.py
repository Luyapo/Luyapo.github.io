...
pygame.init()
WINDOW_WIDTH, WINDOW_HEIGHT = 913, 582
displayscreen = pygame.display.set_mode((WINDOW_WIDTH, WINDOW_HEIGHT))
pygame.display.set_caption("Catch the Ghost!")
#Game Setting
FPS = 60
...
font = pygame.font.Font("HorrorCorpsDemo.otf", 32)

PINK = (234, 191, 218)
PURPLE = (203, 190, 218)

title_text = font.render("Catch the Ghost!", True, PINK)
...
lives_text = font.render("Lives: "+str(score), True, PURPLE)
lives_rect = lives_text.get_rect()
lives_rect.topright = (WINDOW_WIDTH-50, 50)

gameover_text = font.render("GAMEOVER", True, PINK)
gameover_rect = gameover_text.get_rect()
gameover_rect.center = (WINDOW_WIDTH, WINDOW_HEIGHT)
...
cat_image = pygame.image.load("ghost.png")
cat_rect = cat_image.get_rect()
cat_rect.center = (WINDOW_WIDTH//2, WINDOW_HEIGHT//2)

click_sound = pygame.mixer.Sound("get.wav")
miss_sound  = pygame.mixer.Sound("lose.wav")
